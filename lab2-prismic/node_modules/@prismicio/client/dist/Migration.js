...
import { filledContentRelationship, filledLinkToMedia, rtImageNode, filledImage } from "./lib/isValue.js";
import { validateAssetMetadata } from "./lib/validateAssetMetadata.js";
...
class Migration {
  ...
  createDocument(document, title, params) {
    const doc = new PrismicMigrationDocument(document, title, params);
  ...
  updateDocument(document, title) {
    const doc = new PrismicMigrationDocument(document, title);
    this._documents.push(doc);
    return doc;
  }
  /**
