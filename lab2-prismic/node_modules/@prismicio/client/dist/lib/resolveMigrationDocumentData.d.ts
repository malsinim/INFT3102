 ...
 */
export declare function resolveMigrationContentRelationship(relation: MigrationContentRelationship): Promise<MigrationContentRelationshipField>;
/**
 ...
 */
export declare const resolveMigrationLinkToMedia: (linkToMedia: MigrationLinkToMedia, migration: Migration) => MigrationLinkToMediaField;
/**
