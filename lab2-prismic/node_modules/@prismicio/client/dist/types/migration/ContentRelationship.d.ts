 ...
 */
export type MigrationContentRelationship<TDocuments extends PrismicDocument = PrismicDocument> = ValueOrThunk<TDocuments | PrismicMigrationDocument<TDocuments> | undefined> | (Pick<FilledContentRelationshipField, "link_type"> & Partial<Pick<FilledContentRelationshipField, "text">> & {
 ...
 */
export type MigrationContentRelationshipField = Pick<FilledContentRelationshipField, "link_type" | "id"> | EmptyLinkField<"Document">;
export {};
